...
package com.brockoli.android.util;

import android.util.Log;

/**
 * SparseArrays map longs to Objects. Unlike a normal array of Objects, there can be gaps in the indices. It is intended
 * to be more efficient than using a HashMap to map Longs to Objects.
 * 
 * @hide
 */
public class LongSparseArray<E> {
    ...
    /**
     * Given an index in the range <code>0...size()-1</code>, sets a new value for the <code>index</code>th key-value
     * mapping that this SparseArray stores.
     */
